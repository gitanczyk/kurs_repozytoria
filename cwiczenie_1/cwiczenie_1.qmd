...
#| error: false
#| include: false
# Proszę nie ustawiać, ale dymyślnie zakłądac plik projektu w folderze roboczym
...
Pozytywne zaskoczenie :) Skąd pan znał ta metodę o opracowaną przez Polskiego Naukowca z wrocławia.
...
W wyniku wybrano następującą kombinację do dalszej analizy z uwagi na największą pojemność informacyjną zmiennych objaśniających:
...
Jest w tym trochę prawdy. Tak metoda ma wady. Ale ...

Proponuję podać zakres zastosowania modelu. Pedkość wiatru modelu zdefiniowana jest w **\[m/s\]** a nie `[km/h]`. W efekcie otrzymał pan irracjonalne wyniki dla nierealnej sytuacji.

100 \[m/s\] to \`r 100 \* 3.6\` \[km/h\]  - gdzieś w środku tornada takie prędkości występują.
