...
Metoda nie odpowiednia dla klasyfikacji.
...
Proszę na podstawie daty utworzyć dodatkowe nowe zmienne,

W poleceniu jest napisane, jakie kombinacje należy sprawdzić modelowania, niestety nie da się tego zrobić na skróty. Ponieważ chcę byście napisali kilka kombinacji receptur i sprawdzili, która jest najlepsza.

Brak zmiennych jakościowych w zestawie danych.
...
Wynik bardzo dobry, ale można osiągnąć więcej około 0.96
